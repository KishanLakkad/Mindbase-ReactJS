...
class Messages extends React.Component {
  ...
  async componentDidMount() {
    ...
    axios.get(`/user/getByDepartment/${localStorage.getItem("mb_department")}`)
  ...
  loadChats(userIndex){
    ...
    console.log(this.state.userList[userIndex]);
    this.setState({
      senderId,
      recieverId,
      senderProfile,
  ...
  uploadFile(event){
    ...
    FR.addEventListener("load", function(e) {
      ...
      axios.defaults.headers.common['Authorization'] = localStorage.getItem("mb_autorization");
      axios.post(`/media/uploadImageUrl`,{ media: [e.target.result] })
      .then(function (response) {
        if(response.status === 200){
          console.log(response.data);
          self.setState({
            fileUploadLoad: true,
            fileUrl: response.data.data.media[0]
          });
        }
      })
      .catch(function (error) {
              ...
              <div className="col-md-8">
                {
                  ...
                  <div style={{backgroundColor: "#FFFFFF",borderRadius: 20,overflow: "hidden"}}>
                    ...
                    <div id="mychat" style={{overflowY: "scroll",height: "61vh",padding: 15}} data-simplebar data-simplebar-autohide="true">
                      {
                            ...
                            return <div style={{width: "80%",float: "right",paddingTop: 20}}>
                              <div className="row" style={{marginBottom: 5}}>
                                ...
                                <div className="col-7 text-right">
                                  <span style={{display: "block",fontSize: 12}}>{localStorage.getItem("mb_department_text")}</span>
